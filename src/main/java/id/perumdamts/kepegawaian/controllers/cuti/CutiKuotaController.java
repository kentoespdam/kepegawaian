...
public class CutiKuotaController {
    ...
    @GetMapping("/{id}/{tahun}/pegawai")
    public ResponseEntity<?> showByPegawai(@PathVariable Long id, @PathVariable Integer tahun) {
        return CustomResult.any(service.findByPegawai(id, tahun));
    }
