...
import id.perumdamts.kepegawaian.services.master.jenjangPendidikan.JenjangPendidikanService;
...
public class JenjangPendidikanController {
    private final JenjangPendidikanService service;

    @GetMapping
    public ResponseEntity<?> index(@ParameterObject JenjangPendidikanRequest request) {
