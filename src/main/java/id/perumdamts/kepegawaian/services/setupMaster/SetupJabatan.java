...
public class SetupJabatan implements SetupMaster {
    ...
    private void updateData() {
        ...
        list.add(new Jabatan(53L, "1.1", new Jabatan(2L), new Organisasi(5L), new Level(5L), "Manajer Satuan Pengawas Intern"));
        list.add(new Jabatan(54L, "1.1.1", new Jabatan(53L), new Organisasi(60L), new Level(6L), "Supervisor Standardisasi"));
        list.add(new Jabatan(55L, "1.1.1.1", new Jabatan(54L), new Organisasi(60L), new Level(7L), "Staf Sub Bag. Standardisasi"));
        list.add(new Jabatan(56L, "1.1.2", new Jabatan(53L), new Organisasi(61L), new Level(6L), "Supervisor Audit Intern"));
        list.add(new Jabatan(57L, "1.1.2.1", new Jabatan(56L), new Organisasi(61L), new Level(7L), "Staf Sub Bag. Audit Intern"));
        list.add(new Jabatan(58L, "1.1.5", new Jabatan(53L), new Organisasi(62L), new Level(5L), "Ka. Sub Bid. Pengendalian Dokumen"));
        list.add(new Jabatan(59L, "1.1.5.1", new Jabatan(58L), new Organisasi(62L), new Level(7L), "Staf Sub Bid. Pengendalian Dokumen"));
        ...
        list.add(new Jabatan(70L, "1.3", new Jabatan(2L), new Organisasi(8L), new Level(5L), "Manajer Cabang Purwokerto 1"));
        list.add(new Jabatan(71L, "1.3.1", new Jabatan(70L), new Organisasi(21L), new Level(6L), "Supervisor Adm & Keu Cab. Pwkt 1"));
        list.add(new Jabatan(72L, "1.3.1.1", new Jabatan(71L), new Organisasi(21L), new Level(7L), "Staf Sub Bag. Adm & Keu Cab. Pwkt 1"));
        list.add(new Jabatan(73L, "1.3.2", new Jabatan(70L), new Organisasi(22L), new Level(5L), "Ka. Sub Bag. Umum Cab. Pwkt 1"));
        list.add(new Jabatan(74L, "1.3.2.1", new Jabatan(73L), new Organisasi(22L), new Level(7L), "Staf Sub Bag. Umum Cab. Pwkt 1"));
        list.add(new Jabatan(75L, "1.3.2", new Jabatan(70L), new Organisasi(23L), new Level(6L), "Supervisor Pelayanan Cab. Pwkt 1"));
        list.add(new Jabatan(76L, "1.3.2.2", new Jabatan(75L), new Organisasi(23L), new Level(7L), "Staf Sub Bag. Pelayanan Cab. Pwkt 1"));
        list.add(new Jabatan(77L, "1.3.3", new Jabatan(70L), new Organisasi(24L), new Level(6L), "Supervisor Teknik Cab. Pwkt 1"));
        list.add(new Jabatan(78L, "1.3.3.1", new Jabatan(77L), new Organisasi(24L), new Level(7L), "Staf Sub Bag. Teknik Cab. Pwkt 1"));
        list.add(new Jabatan(79L, "1.4", new Jabatan(2L), new Organisasi(9L), new Level(5L), "Manajer Cabang Purwokerto 2"));
        list.add(new Jabatan(80L, "1.4.1", new Jabatan(79L), new Organisasi(25L), new Level(6L), "Supervisor Adm & Keu Cab. Pwkt 2"));
        list.add(new Jabatan(81L, "1.4.1.1", new Jabatan(80L), new Organisasi(25L), new Level(7L), "Staf Sub Bag. Adm & Keu Cab. Pwkt 2"));
        list.add(new Jabatan(82L, "1.4.1", new Jabatan(79L), new Organisasi(26L), new Level(5L), "Ka. Sub Bag. Umum Cab. Pwkt 2"));
        list.add(new Jabatan(83L, "1.4.1.2", new Jabatan(82L), new Organisasi(26L), new Level(7L), "Staf Sub Bag. Umum Cab. Pwkt 2"));
        list.add(new Jabatan(84L, "1.4.2", new Jabatan(79L), new Organisasi(27L), new Level(6L), "Supervisor Pelayanan Cab. Pwkt 2"));
        list.add(new Jabatan(85L, "1.4.2.1", new Jabatan(84L), new Organisasi(27L), new Level(7L), "Staf Sub Bag. Pelayanan Cab. Pwkt 2"));
        list.add(new Jabatan(86L, "1.4.3", new Jabatan(79L), new Organisasi(28L), new Level(6L), "Supervisor Teknik Cab. Pwkt 2"));
        list.add(new Jabatan(87L, "1.4.3.1", new Jabatan(86L), new Organisasi(28L), new Level(7L), "Staf Sub Bag. Teknik Cab. Pwkt 2"));
        list.add(new Jabatan(88L, "1.5", new Jabatan(2L), new Organisasi(10L), new Level(5L), "Manajer Cabang Ajibarang"));
        list.add(new Jabatan(89L, "1.5.1", new Jabatan(88L), new Organisasi(29L), new Level(6L), "Supervisor Adm & Keu Cab. Ajibarang"));
        list.add(new Jabatan(90L, "1.5.1.1", new Jabatan(89L), new Organisasi(29L), new Level(7L), "Staf Sub Bag. Adm & Keu Cab. Ajibarang"));
        list.add(new Jabatan(91L, "1.5.1", new Jabatan(88L), new Organisasi(30L), new Level(5L), "Ka. Sub Bag. Umum Cab. Ajibarang"));
        list.add(new Jabatan(92L, "1.5.1.2", new Jabatan(91L), new Organisasi(30L), new Level(7L), "Staf Sub Bag. Umum Cab. Ajibarang"));
        list.add(new Jabatan(93L, "1.5.2", new Jabatan(88L), new Organisasi(31L), new Level(6L), "Supervisor Pelayanan Cab. Ajibarang"));
        list.add(new Jabatan(94L, "1.5.2.1", new Jabatan(93L), new Organisasi(31L), new Level(7L), "Staf Sub Bag. Pelayanan Cab. Ajibarang"));
        list.add(new Jabatan(95L, "1.5.3", new Jabatan(88L), new Organisasi(32L), new Level(6L), "Supervisor Teknik Cab. Ajibarang"));
        list.add(new Jabatan(96L, "1.5.3.1", new Jabatan(95L), new Organisasi(32L), new Level(7L), "Staf Sub Bag. Teknik Cab. Ajibarang"));
        list.add(new Jabatan(97L, "1.6", new Jabatan(2L), new Organisasi(11L), new Level(5L), "Manajer Cabang Wangon"));
        list.add(new Jabatan(98L, "1.6.1", new Jabatan(97L), new Organisasi(33L), new Level(6L), "Supervisor Adm & Keu Cab. Wangon"));
        list.add(new Jabatan(99L, "1.6.1.1", new Jabatan(98L), new Organisasi(33L), new Level(7L), "Staf Sub Bag. Adm & Keu Cab. Wangon"));
        list.add(new Jabatan(100L, "1.6.1", new Jabatan(97L), new Organisasi(34L), new Level(5L), "Ka. Sub Bag. Umum Cab. Wangon"));
        list.add(new Jabatan(101L, "1.6.1.2", new Jabatan(100L), new Organisasi(34L), new Level(7L), "Staf Sub Bag. Umum Cab. Wangon"));
        list.add(new Jabatan(102L, "1.6.2", new Jabatan(97L), new Organisasi(35L), new Level(6L), "Supervisor Pelayanan Cab. Wangon"));
        list.add(new Jabatan(103L, "1.6.2.1", new Jabatan(102L), new Organisasi(35L), new Level(7L), "Staf Sub Bag. Pelayanan Cab. Wangon"));
        list.add(new Jabatan(104L, "1.6.3", new Jabatan(97L), new Organisasi(36L), new Level(6L), "Supervisor Teknik Cab. Wangon"));
        list.add(new Jabatan(105L, "1.6.3.1", new Jabatan(104L), new Organisasi(36L), new Level(7L), "Staf Sub Bag. Teknik Cab. Wangon"));
        list.add(new Jabatan(106L, "1.7", new Jabatan(2L), new Organisasi(12L), new Level(5L), "Manajer Cabang Banyumas"));
        list.add(new Jabatan(107L, "1.7.1", new Jabatan(106L), new Organisasi(37L), new Level(6L), "Supervisor Adm & Keu Cab. Banyumas"));
        list.add(new Jabatan(108L, "1.7.1.1", new Jabatan(107L), new Organisasi(37L), new Level(7L), "Staf Sub Bag. Adm & Keu Cab. Banyumas"));
        list.add(new Jabatan(109L, "1.7.1", new Jabatan(106L), new Organisasi(38L), new Level(5L), "Ka. Sub Bag. Umum Cab. Banyumas"));
        list.add(new Jabatan(110L, "1.7.1.2", new Jabatan(109L), new Organisasi(38L), new Level(7L), "Staf Sub Bag. Umum Cab. Banyumas"));
        list.add(new Jabatan(111L, "1.7.2", new Jabatan(106L), new Organisasi(39L), new Level(6L), "Supervisor Pelayanan Cab. Banyumas"));
        list.add(new Jabatan(112L, "1.7.2.1", new Jabatan(111L), new Organisasi(39L), new Level(7L), "Staf Sub Bag. Pelayanan Cab. Banyumas"));
        list.add(new Jabatan(113L, "1.7.3", new Jabatan(106L), new Organisasi(40L), new Level(6L), "Supervisor Teknik Cab. Banyumas"));
        list.add(new Jabatan(114L, "1.7.3.1", new Jabatan(113L), new Organisasi(40L), new Level(7L), "Staf Sub Bag. Teknik Cab. Banyumas"));
