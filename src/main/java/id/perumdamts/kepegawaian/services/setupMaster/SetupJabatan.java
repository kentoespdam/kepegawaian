...
public class SetupJabatan implements SetupMaster {
    ...
    private void updateData() {
        ...
        list.add(new Jabatan(37L,"1.9.2.1", new Jabatan(125L), new Organisasi(45L), new Level(7L),"Staf Sub Bag. Pemasaran"));
        ...
        list.add(new Jabatan(43L,"1.2.2.3.1", new Jabatan(41L), new Organisasi(47L), new Level(7L),"Kepala Satpam"));
        list.add(new Jabatan(44L,"1.2.4.1", new Jabatan(118L), new Organisasi(48L), new Level(6L),"Supervisor Aset"));
        list.add(new Jabatan(45L,"1.2.4.1.1", new Jabatan(44L), new Organisasi(48L), new Level(7L),"Staf Sub Bag. Aset"));
        list.add(new Jabatan(46L,"1.2.4.2", new Jabatan(118L), new Organisasi(49L), new Level(6L),"Supervisor Pengadaan"));
        list.add(new Jabatan(47L,"1.2.4.2.1", new Jabatan(46L), new Organisasi(49L), new Level(7L),"Staf Sub Bag. Pengadaan"));
        ...
        list.add(new Jabatan(54L,"1.3.2", new Jabatan(53L), new Organisasi(60L), new Level(6L),"Supervisor Standardisasi"));
        list.add(new Jabatan(55L,"1.3.2.1", new Jabatan(54L), new Organisasi(60L), new Level(7L),"Staf Sub Bag. Standardisasi"));
        list.add(new Jabatan(56L,"1.3.1", new Jabatan(53L), new Organisasi(61L), new Level(6L),"Supervisor Audit Intern"));
        list.add(new Jabatan(57L,"1.3.1.1", new Jabatan(56L), new Organisasi(61L), new Level(7L),"Staf Sub Bag. Audit Intern"));
        ...
        list.add(new Jabatan(76L,"1.4.2.1", new Jabatan(75L), new Organisasi(23L), new Level(7L),"Staf Sub Bag. Pelayanan Cab. Pwkt 1"));
        ...
        list.add(new Jabatan(118L,"1.2.4", new Jabatan(25L), new Organisasi(69L), new Level(5L),"Manajer Perlengkapan"));
        list.add(new Jabatan(119L,"1.9", new Jabatan(2L), new Organisasi(68L), new Level(5L),"Manajer Unit Bisnis AMDK"));
        list.add(new Jabatan(121L,"1.1.3.2", new Jabatan(14L), new Organisasi(72L), new Level(6L),"Supervisor Pengendalian Produksi 2"));
        list.add(new Jabatan(123L,"1.2.4.3", new Jabatan(118L), new Organisasi(74L), new Level(6L),"Supervisor Persediaan"));
        list.add(new Jabatan(124L,"1.9.1", new Jabatan(119L), new Organisasi(75L), new Level(6L),"Supervisor Produksi"));
        list.add(new Jabatan(125L,"1.9.2", new Jabatan(119L), new Organisasi(45L), new Level(6L),"Supervisor Pemasaran"));
        list.add(new Jabatan(126L,"1.9.1.1", new Jabatan(124L), new Organisasi(75L), new Level(7L),"Staf Sub Bag. Produksi"));
        ...
        list.add(new Jabatan(130L,"1.2.4.3.1", new Jabatan(123L), new Organisasi(74L), new Level(7L),"Staf Sub Bag. Persediaan"));
    ...
    private void cleanup() {
        Specification<Jabatan> where = (root, query, criteriaBuilder) ->
                criteriaBuilder.like(root.get("nama"), "%jabatan%");
