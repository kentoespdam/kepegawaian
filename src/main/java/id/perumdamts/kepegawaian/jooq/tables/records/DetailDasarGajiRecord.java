...
public class DetailDasarGajiRecord extends UpdatableRecordImpl<DetailDasarGajiRecord> {
     ...
     */
    public DetailDasarGajiRecord(Long id_, Byte changedStatus, Integer golonganKode, Integer mkg, Double nominal, Long dasarGajiId, LocalDateTime createdAt, String createdBy, Boolean isDeleted, LocalDateTime updatedAt, String updatedBy, Integer version) {
        super(DetailDasarGaji.DETAIL_DASAR_GAJI);
