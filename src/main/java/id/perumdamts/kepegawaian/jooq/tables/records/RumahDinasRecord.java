...
public class RumahDinasRecord extends UpdatableRecordImpl<RumahDinasRecord> {
     ...
     */
    public RumahDinasRecord(Long id_, String nama, Double nilai, LocalDateTime createdAt, String createdBy, Boolean isDeleted, LocalDateTime updatedAt, String updatedBy) {
        super(RumahDinas.RUMAH_DINAS);
