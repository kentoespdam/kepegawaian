...
public class HariLiburRecord extends UpdatableRecordImpl<HariLiburRecord> {
     ...
     */
    public HariLiburRecord(Long id_, Byte changedStatus, LocalDateTime createdAt, String createdBy, Boolean isDeleted, LocalDateTime updatedAt, String updatedBy, Integer version, Byte jenisLibur, String notes, LocalDate tanggal) {
        super(HariLibur.HARI_LIBUR);
