...
This project uses **beads (`bd`)**. See CLAUDE.md for tracker rules and session completion protocol. Run `bd prime`.
...
This project is indexed by GitNexus as **kepegawaian** (19024 symbols, 47185 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
